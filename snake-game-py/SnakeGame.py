...
class cube(object):
    ...
    def __init__(self, start, dirnx=1, dirny=0, color=(169, 169, 169)):
        self.pos = start
        self.dirnx = 1
        self.dirny = 0
        self.color = color
    ...
    def draw(self, surface, eyes=False):
        ...
        if eyes:
            centre = dis//2
            radius = 3
            circleMiddle = (i*dis+centre-radius, j*dis+7)
            circleMiddle2 = (i*dis + dis - radius*2, j*dis+7)
